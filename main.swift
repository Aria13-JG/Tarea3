...
func main(){
  ...
  almacen.addProducts(producto: "tenisNike", cantidad: 5)
  almacen.addProducts(producto: "quesoLaVilla", cantidad: 20)
    ...
    almacen.removeProducts(producto: "quesoLaVilla", cantidad: 10)
    almacen.removeProducts(producto: "tenisNike", cantidad: 1)
